...
## with modification of priors 11/12/2021
...
# mean_s2        0.827   0.000 0.020     0.786     0.814     0.828     0.842     0.864  3817 0.999
# mean_eta       0.008   0.000 0.008     0.000     0.002     0.006     0.011     0.030  2921 1.001
# mean_r         0.137   0.000 0.009     0.120     0.131     0.137     0.142     0.155  3305 1.000
# mean_p         0.021   0.000 0.004     0.013     0.018     0.020     0.023     0.030  3374 0.999
# beta           0.079   0.001 0.095    -0.105     0.015     0.078     0.141     0.268  4787 0.999
# mu_juvsurv    -0.477   0.002 0.121    -0.716    -0.560    -0.475    -0.394    -0.248  3318 0.999
# lp__       -1348.440   0.048 1.772 -1352.659 -1349.372 -1348.086 -1347.148 -1345.979  1361 1.001
# 
# Samples were drawn using NUTS(diag_e) at Thu Mar 11 10:18:31 2021.
...
BF # Estimated Bayes factor in favor of bridge_juvad2 over bridge_juvad3: 419512093.40824 = 10^8.62 ### Well, that's a lot....
# Check errors
...
BF20 ### Estimated Bayes factor in favor of bridge_juvad2 over bridge_juvad0: 0.11077 = 10^{-0.95} instead of 0.00911 = 10^{-2}

# Bayes factor of model A over model B
BF02 = bf(bridge_juvad0,bridge_juvad2) # just to check computation
BF02 ## approx. 10 (9.02) still decisive -- combination to prior odds ? 
...
BF0S
### Estimated Bayes factor in favor of bridge_juvad0 over bridge_juvadS: 3971737568749828680447950848.00000= 10^27 // same conclusion. 
